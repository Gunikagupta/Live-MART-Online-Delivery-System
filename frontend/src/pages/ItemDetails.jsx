...
const items = [
  { itemId: 1, itemName: "Organic Brown Eggs", price: 95, stockQuantity: 12, shopName: "Green Farm Organics", distanceKm: 1.2 },
  { itemId: 2, itemName: "Amul Butter (500g)", price: 275, stockQuantity: 45, shopName: "SuperMart Daily", distanceKm: 0.8 },
  { itemId: 3, itemName: "Whole Wheat Bread", price: 60, stockQuantity: 0, shopName: "The Bakery Junction", distanceKm: 2.5 },
  { itemId: 4, itemName: "Basmati Rice (5kg)", price: 850, stockQuantity: 8, shopName: "Kirana King", distanceKm: 3.1 },
  { itemId: 5, itemName: "Fresh Paneer", price: 120, stockQuantity: 15, shopName: "Daily Dairy", distanceKm: 1.5 },
  { itemId: 6, itemName: "Coca Cola (2L)", price: 90, stockQuantity: 100, shopName: "Beverage Depot", distanceKm: 4.2 },
];
